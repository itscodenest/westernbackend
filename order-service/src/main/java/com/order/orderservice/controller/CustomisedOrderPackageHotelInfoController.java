...
import com.order.orderservice.facade.CustomisedOrderPackageHotelInfoFacade;
...
public class CustomisedOrderPackageHotelInfoController {

	@Autowired
	private CustomisedOrderPackageHotelInfoFacade customisePackageHotelInfoFacade;

	@PostMapping
	public CustomisePackageHotelInfoPojoResponse createOrder(
			@RequestBody CustomisedOrderPackageHotelInfoPojo customisePackageHotelInfoPojo) {
